...
public class PractiseModel extends JFrame{
	...
	public PractiseModel() {
		...
		btnNewButton_2.setBounds(502, 256, 95, 38);
		...
		button.setBounds(524, 89, 89, 23);
		getContentPane().add(button);
		
		JButton button_1 = new JButton("left");
		button_1.setBounds(463, 138, 89, 23);
		getContentPane().add(button_1);
		
		JButton button_2 = new JButton("down");
		button_2.setBounds(524, 191, 89, 23);
		getContentPane().add(button_2);
		
		JButton button_3 = new JButton("right");
		button_3.setBounds(581, 138, 89, 23);

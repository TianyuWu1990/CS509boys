...
public class GuestGameJFrameNew extends JFrame{
	...
	public GuestGameJFrameNew() {
		setTitle("Eric's Game");
		getContentPane().setLayout(null);
		
		JButton btnNewButton_2 = new JButton("Exit");
		btnNewButton_2.setBounds(451, 399, 96, 50);
		...
		textField_1.setBounds(97, 320, 86, 20);
		getContentPane().add(textField_1);
		
		textField_2 = new JTextField();
		textField_2.setText("0");
		textField_2.setColumns(10);
		textField_2.setBounds(97, 351, 86, 20);
		getContentPane().add(textField_2);
		
		textField_3 = new JTextField();
		textField_3.setText("0");
		textField_3.setColumns(10);
		textField_3.setBounds(97, 382, 86, 20);
		getContentPane().add(textField_3);
		
		textField_4 = new JTextField();
		textField_4.setText("0");
		textField_4.setColumns(10);
		textField_4.setBounds(97, 414, 86, 20);
		getContentPane().add(textField_4);
		
		JButton btnNewButton_1 = new JButton("up");
		btnNewButton_1.setBounds(502, 112, 89, 23);
		getContentPane().add(btnNewButton_1);
		
		JButton btnLeft = new JButton("left");
		btnLeft.setBounds(441, 161, 89, 23);
		getContentPane().add(btnLeft);
		
		JButton btnRight = new JButton("right");
		btnRight.setBounds(559, 161, 89, 23);
		getContentPane().add(btnRight);
		
		JButton btnDown = new JButton("down");
		btnDown.setBounds(502, 214, 89, 23);

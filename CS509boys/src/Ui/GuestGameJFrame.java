...
public class GuestGameJFrame extends JFrame{
	...
	public GuestGameJFrame() {
		setTitle("Eric's Game");
		getContentPane().setLayout(null);
		
		JButton btnNewButton_2 = new JButton("Exit");
		btnNewButton_2.setBounds(443, 368, 96, 50);
		...
		button.setBounds(452, 161, 89, 23);
		getContentPane().add(button);
		
		JButton button_1 = new JButton("down");
		button_1.setBounds(513, 214, 89, 23);
		getContentPane().add(button_1);
		
		JButton button_3 = new JButton("up");
		button_3.setBounds(513, 112, 89, 23);
		getContentPane().add(button_3);
		
		JButton button_4 = new JButton("right");
		button_4.setBounds(570, 161, 89, 23);

...
public class GameJFramev2 extends JFrame{
	...
	public GameJFramev2() {
		...
		btnNewButton.setBounds(492, 268, 89, 23);
		getContentPane().add(btnNewButton);
		
		JButton btnNewButton_1 = new JButton("Lock");
		btnNewButton_1.setBounds(492, 328, 89, 23);
		getContentPane().add(btnNewButton_1);
		
		JButton btnNewButton_2 = new JButton("Exit");
		btnNewButton_2.setBounds(492, 389, 89, 23);
		...
		button.setBounds(511, 89, 89, 23);
		getContentPane().add(button);
		
		JButton button_1 = new JButton("left");
		button_1.setBounds(450, 138, 89, 23);
		getContentPane().add(button_1);
		
		JButton button_2 = new JButton("right");
		button_2.setBounds(568, 138, 89, 23);
		getContentPane().add(button_2);
		
		JButton button_3 = new JButton("down");
		button_3.setBounds(511, 191, 89, 23);

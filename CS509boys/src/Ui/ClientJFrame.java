...
public class ClientJFrame extends JFrame {
	...
	public ClientJFrame() {
		...
		JButton btnYourHistory = new JButton("Your History");
		btnYourHistory.setBounds(362, 375, 127, 23);
		contentPane.add(btnYourHistory);
		...
		btnRefresh.setBounds(659, 60, 127, 28);
		...
		btnPractiseModel.setBounds(198, 375, 111, 23);
		...
		btnNewButton.setBounds(659, 137, 127, 23);

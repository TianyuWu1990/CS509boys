...
public class GuestGameJFrameHalf extends JFrame{
	...
	public GuestGameJFrameHalf() {
		...
		btnNewButton_2.setBounds(505, 353, 96, 50);
		...
		button.setBounds(438, 161, 89, 23);
		getContentPane().add(button);
		
		JButton button_1 = new JButton("down");
		button_1.setBounds(499, 214, 89, 23);
		getContentPane().add(button_1);
		
		JButton button_3 = new JButton("up");
		button_3.setBounds(499, 112, 89, 23);
		getContentPane().add(button_3);
		
		JButton button_4 = new JButton("right");
		button_4.setBounds(556, 161, 89, 23);

...
public class ManagerGameJFramev2Restart extends JFrame{
	...
	public ManagerGameJFramev2Restart() {
		setTitle("Your Game");
		getContentPane().setLayout(null);
		
		JButton btnNewButton = new JButton("Restart");
		btnNewButton.setBounds(495, 285, 89, 23);
		getContentPane().add(btnNewButton);
		
		JButton btnNewButton_1 = new JButton("Lock");
		btnNewButton_1.setBounds(495, 338, 89, 23);
		getContentPane().add(btnNewButton_1);
		
		JButton btnNewButton_2 = new JButton("Exit");
		btnNewButton_2.setBounds(495, 387, 89, 23);
		...
		button.setBounds(468, 138, 89, 23);
		getContentPane().add(button);
		
		JButton button_1 = new JButton("down");
		button_1.setBounds(529, 191, 89, 23);
		getContentPane().add(button_1);
		
		JButton button_2 = new JButton("up");
		button_2.setBounds(529, 89, 89, 23);
		getContentPane().add(button_2);
		
		JButton button_3 = new JButton("right");
		button_3.setBounds(586, 138, 89, 23);
